...
export default function SidebarNav({ setLoggedIn, username }) {
    ...
    return (
        <div className={`w-72 min-h-full border-r-2 border-r-gray-400 bg-[#0b2431] text-white py-3 flex flex-col`}>
            ...
            <button onClick={() => navigate('/cart', { replace: true })} className={`w-full font-mono text-gray-300 flex items-center hover:bg-gray-500 hover:bg-opacity-75 text-left px-5 py-3 text-xl mb-4`}><IoCartOutline size={25} className={`fill-gray-300 mr-5`} />Cart</button>
